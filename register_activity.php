...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkInscription = $pdo->prepare("SELECT * FROM INSCRIPTION WHERE USER = ? AND CODEANIM = ? AND DATEACT = ? AND DATEANNULE IS NULL");
    $checkInscription->execute([$user, $activityCode, $activityDate]);
